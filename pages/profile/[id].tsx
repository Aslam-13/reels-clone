 ...
 useEffect(()=>{
  ...
  return (
    <div className="w-full">
      <div className="flex gap-6 md:gap-10 mg-4 bg-white w-full">
      ...
      <div className='w-16 h-16 md:w-32 md:h-32'>
              ...
              <div className="flex flex-col justify-center">       
                <p className=' md:text-2xl flex tracking-wider gap-1 items-center justify-center text-md font-bold text-primary lowercase'>
